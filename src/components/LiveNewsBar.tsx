...
export function LiveNewsBar({ items }: { items: NewsItem[] }) {
  ...
  return (
    <div className="surface-glass dark absolute inset-x-4 bottom-6 z-10 mx-auto flex max-w-3xl items-center gap-3 rounded-full py-2 pr-5 pl-2 text-foreground sm:inset-x-0 sm:bottom-10 sm:gap-4">
      <Link
        to="/news/$slug"
