...
import erciyas from "../assets/logos/erciyas.png";
import europeanHyperloopCenter from "../assets/logos/european-hyperloop-center.png";
import eurotube from "../assets/logos/eurotube.png";
...
export const logos = {
  ...
  erciyas: erciyas,
  europeanHyperloopCenter: europeanHyperloopCenter,
  eurotube: eurotube,
  geste: geste,
  hague: hague,
  hardt: hardt,
